...
export default function Office({ userId }: { userId: string }) {
    ...
    useEffect(() => {
        if (isRiddleOpen) {
            ...
            const newRiddles = [
                ...
                "I come in a box with a lot of letters. Yet I am all alone, waiting for you. What am I?",
                "I have a spine but no bones. I have a cover but am not a book. Inside me, you find information but not knowledge. What am I?",
                "I'm white, rectangular, and you can write on me. People often use me to jot down notes. What am I?",
                "I'm a tool with teeth but not for eating. I have hands but don't clap. What am I?",
                "I have many ears but cannot hear. I have a long tail but am not a creature. What am I?",
                "I'm on a desk, and you click on me. I'm small but mighty, helping you navigate easily. What am I?",
                "I'm a small accessory on your desk. I can correct mistakes with ease. What am I?",
                "I'm sticky and come on a roll. You use me to keep things together. What am I?",
                "I have numbers and hands but never tick. I help you organize your day and set the time. What am I?"
            ];
    ...
    return (
        <div>
            ...
            <h1 className='text-3xl md:text-5xl text-center'>Office</h1>
